...
const PRODUCTS_COLUMNS = [Columns.ID, COLUMN_NAME, COLUMN_BRAND, COLUMN_DESCRIPTION];
const PRODUCTS_ALIASES = [PRODUCTS_ALIAS_ID, PRODUCTS_ALIAS_NAME, PRODUCTS_ALIAS_BRAND, PRODUCTS_ALIAS_DESCRIPTION];
